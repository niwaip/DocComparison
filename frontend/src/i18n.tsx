...
const zhCN: Dict = {
  ...
  'rules.save.success.ruleset': '保存成功：规则集已更新',
  'rules.save.success.templateAndRuleset': '保存成功：{templateId}@{version} 已写入模板库，规则集已更新',
  'rules.save.failed': '保存失败',
  ...
  'rules.blockRules.filter.inputs': '输入',
  'rules.blockRules.filter.all': '全部',
...
const enUS: Dict = {
  ...
  'rules.save.success.ruleset': 'Saved: ruleset updated',
  'rules.save.success.templateAndRuleset': 'Saved: template {templateId}@{version} and ruleset updated',
  'rules.save.failed': 'Save failed',
  ...
  'rules.blockRules.filter.inputs': 'Inputs',
  'rules.blockRules.filter.all': 'All',
